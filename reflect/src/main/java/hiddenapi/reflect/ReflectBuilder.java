...
/**
 * 反射工具类，可缓存反射。 For example: Canvas canvas = new Canvas(bitmap); try { ReflectBuilder.from(canvas).method("setXXX", new Class[]{int.class}).invoke(canvas, 2); } catch (Exception ignored) { }
 */
...
public class ReflectBuilder {
    ...
    private static class DefaultReflectMethod implements IReflectMethod {
        ...
        @Override
        public Object invokeStatic(Object... args) throws InvocationTargetException, IllegalArgumentException, IllegalAccessException {
            return invoke(null, args);
        }

        @Override
        public <T> T invokeAs(Object receiver, Object... args) throws InvocationTargetException, IllegalArgumentException, IllegalAccessException, ClassCastException {
            return (T) invoke(receiver, args);
        }

        @Override
        public <T> T invokeStaticAs(Object... args) throws InvocationTargetException, IllegalArgumentException, IllegalAccessException, ClassCastException {
            return invokeAs(null, args);
        }
    }
    ...
    private static class DefaultReflectField implements IReflectField {
        ...
        @Override
        public <T> T getAs(Object o) throws IllegalAccessException, IllegalArgumentException {
            return (T) get(o);
        }

        @Override
        public <T> T getStaticAs() throws IllegalAccessException, IllegalArgumentException, ClassCastException {
            return getAs(null);
        }
    ...
    public interface IReflectMethod {
        ...
        Object invokeStatic(Object... args) throws
                InvocationTargetException,
                IllegalArgumentException,
                IllegalAccessException;

        <T> T invokeAs(Object receiver, Object... args) throws
                InvocationTargetException,
                IllegalArgumentException,
                IllegalAccessException,
                ClassCastException;

        <T> T invokeStaticAs(Object... args) throws
                InvocationTargetException,
                IllegalArgumentException,
                IllegalAccessException,
                ClassCastException;
    ...
    public interface IReflectField {
        ...
        <T> T getAs(Object o) throws IllegalAccessException, IllegalArgumentException, ClassCastException;

        <T> T getStaticAs() throws IllegalAccessException, IllegalArgumentException, ClassCastException;
